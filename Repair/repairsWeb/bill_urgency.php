...
<?php
    ...
    function ShowTable(){
	 ...
	 $sql="select * from urgenyorder";				//在这里添加、更换数据表
        ...
        while($row=mysql_fetch_array($queryj)){  
			...
			//<a href='index.html'><i class='fa fa-pencil'></i></a> 
			echo "<td>
			<a href='expand/script/urgency_delete.php?id=$id' role='button' data-toggle='modal'>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="error-text"><i class="fa fa-warning modal-icon"></i>你确定要删除这条投诉信息吗？<br>
          这无法恢复！</p>
      </div>
