...
<%
   ...
   did=new String(request.getParameter("did").getBytes("ISO-8859-1"),"UTF-8");
   }
  %>
<div class="content">
<ul class="breadcrumb">
  ...
  <div class="row-fluid">
    ...
    <div class="well">
      <ul class="nav nav-tabs">
        <li class="active"><a href="http://www.baidu.com" data-toggle="tab">请填写要添加的学生资料</a></li>
      </ul>
      <div id="myTabContent" class="tab-content">
        <div class="tab-pane active in" id="home">
		<form id="tab" method="post" action="/mvcDorm/Student_DoAdd" autocomplete="off">
          <label>学生学号</label>
          <input type="text" name="snumber" value="" class="input-xlarge" autofocus="true" required="true" >
          <label>姓名</label>
          <input type="text" name="sname" value="" class="input-xlarge" required="true" >
          <label>性别</label>
          <input type="text" name="ssex" value="" class="input-xlarge" required="true">
          <label>联系电话</label>
          <input type="text" name="sphone" value="" class="input-xlarge" required="true" >
            <label>家庭住址</label>
          ...
          <select name="scollege" id="" class="input-xlarge">
            ...
            <label>宿舍号</label>
          <input type="text" name="sclass" value="<%=did %>" class="input-xlarge" required="true">
           <label>床位号</label>
