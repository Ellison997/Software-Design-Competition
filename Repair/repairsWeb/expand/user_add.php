    ...
    <div class="well">
      ...
      <div id="myTabContent" class="tab-content">
        <div class="tab-pane active in" id="home">
          <form id="tab" method="post" action="script/user_addp.php" autocomplete="off">
            <label>用户名</label>
            ...
            <label>信用等级</label>
            <input type="text" name="user_prestige" value="" class="input-xlarge" autofocus="true" required="true" >
