...
<div class="btn-toolbar list-toolbar">
  <button onclick="javascript:window.location.href='expand/staff_add.php';" class="btn btn-primary" ><i class="fa fa-plus"></i> 新的员工</button>
...
<?php
    ...
    function ShowTable(){
	 ...
	 $sql="select * from servicer";				//在这里添加、更换数据表
        ...
        while($row=mysql_fetch_array($queryj)){  
			...
			echo "<td><a href='expand/staff_update.php?id=$id'><i class='fa fa-pencil'></i></a> 
			<a href='expand/script/staff_delete.php?id=$id' role='button' data-toggle='modal'><i class='fa fa-trash-o'></i></a></td>";
            echo "</tr>";
        }
        echo "</tbody></table>";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="error-text"><i class="fa fa-warning modal-icon"></i>你确定要删除员工吗？<br>
          这无法恢复！</p>
      </div>
