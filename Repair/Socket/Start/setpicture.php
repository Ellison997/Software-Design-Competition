...
file_put_contents($uploads_dir.'juhl.txt', print_r($file, true));
 $uploadtitle = 'http://127.0.0.1/Repair/Socket/Start/img/'+$_POST["title"];
 
 $sqls="update servicer set picture='/Repair/Socket/Start/img/$file'   where phonenumber='$userphone'";
